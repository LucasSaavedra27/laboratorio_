...
def abreviar_numero(numero):
    if numero >= 1_000_000:
        return f"{numero / 1_000_000:.1f}M"  # Formato en millones (10.5M)
    elif numero >= 1_000:
        return f"{numero / 1_000:.1f}k"  # Formato en miles (10k)
    else:
        return str(numero)  # Menor a 1,000, sin formato especial
...
def estadisticas_ventas(request):
    ...
    total_diario = abreviar_numero(total_diario)
    ...
    total_mensual = abreviar_numero(total_mensual)
